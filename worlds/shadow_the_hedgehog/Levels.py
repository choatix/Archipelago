...
LevelRegion(STAGE_WESTOPOLIS, REGION_INDICES.WESTOPOLIS_GOLD_BEETLE,
    ...
    LevelRegion(STAGE_LETHAL_HIGHWAY, REGION_INDICES.LETHAL_HIGHWAY_FIVE_FALL,
                REGION_RESTRICTION_TYPES.NoRestriction),
    LevelRegion(STAGE_LETHAL_HIGHWAY, REGION_INDICES.LETHAL_HIGHWAY_DEFEATED_CRAFT,
                REGION_RESTRICTION_TYPES.Craft).setAsDiversion()
        .setFromRegion([REGION_INDICES.LETHAL_HIGHWAY_CHECKPOINT_ZERO,
                        REGION_INDICES.LETHAL_HIGHWAY_CHECKPOINT_ONE,
                        REGION_INDICES.LETHAL_HIGHWAY_CHECKPOINT_THREE,
                        REGION_INDICES.LETHAL_HIGHWAY_CHECKPOINT_FOUR,
...
LevelRegion(STAGE_CRYPTIC_CASTLE, REGION_INDICES.CRYPTIC_CASTLE_FIVE_BALLOON,
    ...
    LevelRegion(STAGE_CIRCUS_PARK, REGION_INDICES.CIRCUS_PARK_CHECKPOINT_THREE,
                REGION_RESTRICTION_TYPES.NoRestriction),
    LevelRegion(STAGE_CIRCUS_PARK, REGION_INDICES.CIRCUS_PARK_THREE_BELL,
                REGION_RESTRICTION_TYPES.NoRestriction).setAsDiversion(),
    LevelRegion(STAGE_CIRCUS_PARK, REGION_INDICES.CIRCUS_PARK_THREE_LOWER,
                REGION_RESTRICTION_TYPES.NoRestriction)
        .setFromRegion(REGION_INDICES.CIRCUS_PARK_CHECKPOINT_THREE),
    ...
    LevelRegion(STAGE_CIRCUS_PARK, REGION_INDICES.CIRCUS_PARK_CHECKPOINT_SEVEN,
                REGION_RESTRICTION_TYPES.NoRestriction),
    LevelRegion(STAGE_CIRCUS_PARK, REGION_INDICES.CIRCUS_PARK_RINGS_COLLECTED,
                REGION_RESTRICTION_TYPES.Rings).setAsDiversion(),
    ...
    LevelRegion(STAGE_THE_DOOM, REGION_INDICES.THE_DOOM_THREE_BOMBS,
                REGION_RESTRICTION_TYPES.Explosion)
        .setFromRegion(REGION_INDICES.THE_DOOM_CHECKPOINT_THREE),
    ...
    LevelRegion(STAGE_THE_DOOM, REGION_INDICES.THE_DOOM_DOOR_1_SWITCH,
                REGION_RESTRICTION_TYPES.NoRestriction)
    .setFromRegion([REGION_INDICES.THE_DOOM_THREE_BOMBS, REGION_INDICES.THE_DOOM_THROUGH_DOOR]),
...
LevelRegion(STAGE_AIR_FLEET, REGION_INDICES.AIR_FLEET_DEFEATED_CRAFT,
            REGION_RESTRICTION_TYPES.Craft).setAsDiversion()
    .setFromRegion([REGION_INDICES.AIR_FLEET_CHECKPOINT_ONE,
                    REGION_INDICES.AIR_FLEET_CHECKPOINT_TWO,
                    REGION_INDICES.AIR_FLEET_CHECKPOINT_FOUR,
                    REGION_INDICES.AIR_FLEET_CHECKPOINT_FIVE,
                    REGION_INDICES.AIR_FLEET_FIVE_TURRET,
                    REGION_INDICES.AIR_FLEET_CHECKPOINT_SIX,
                    REGION_INDICES.AIR_FLEET_CHECKPOINT_SEVEN]),
...
LevelRegion(STAGE_IRON_JUNGLE, REGION_INDICES.IRON_JUNGLE_DEFEATED_CRAFT,
            REGION_RESTRICTION_TYPES.Craft).setAsDiversion()
    .setFromRegion([REGION_INDICES.IRON_JUNGLE_CHECKPOINT_ZERO,
                    REGION_INDICES.IRON_JUNGLE_EARLY_JUMPER,
                    REGION_INDICES.IRON_JUNGLE_ROCKET,
                    REGION_INDICES.IRON_JUNGLE_CHECKPOINT_FIVE,
                    REGION_INDICES.IRON_JUNGLE_HERO_ROCKET
                    ]),
...
LevelRegion(STAGE_COSMIC_FALL, REGION_INDICES.COSMIC_FALL_CHECKPOINT_SEVEN,
    ...
    LevelRegion(STAGE_FINAL_HAUNT, REGION_INDICES.FINAL_HAUNT_FIVE_KEY_DOOR,
                        REGION_RESTRICTION_TYPES.KeyDoor)
        .setFromRegion(REGION_INDICES.FINAL_HAUNT_VOLT_OR_FIVE).setAsDiversion(),
...
BACKTRACKING_REGIONS = [
    ...
    BacktrackRegion(STAGE_CIRCUS_PARK, REGION_INDICES.CIRCUS_PARK_CHECKPOINT_FOUR,
                    ...
                    REGION_RESTRICTION_TYPES.NoBacktracking).setHardLogicOnly(),
    BacktrackRegion(STAGE_CIRCUS_PARK, REGION_INDICES.CIRCUS_PARK_CHECKPOINT_FOUR,
                    REGION_INDICES.CIRCUS_PARK_THREE_BELL, Options.LogicLevel.option_normal,
                    REGION_RESTRICTION_TYPES.NoBacktracking).setHardLogicOnly(),
    ...
    BacktrackRegion(STAGE_IRON_JUNGLE, REGION_INDICES.IRON_JUNGLE_CHECKPOINT_ONE,
                    ...
                    REGION_RESTRICTION_TYPES.NoBacktracking),
    BacktrackRegion(STAGE_IRON_JUNGLE, REGION_INDICES.IRON_JUNGLE_EARLY_JUMPER,
