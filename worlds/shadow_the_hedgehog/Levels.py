...
LevelRegion(STAGE_BLACK_COMET, REGION_INDICIES.BLACK_COMET_TWO_WORMS,
                    REGION_RESTRICTION_TYPES.VacuumOrShot),
LevelRegion(STAGE_BLACK_COMET, REGION_INDICIES.BLACK_COMET_TWO_WEAPON_BALLOON,
                    REGION_RESTRICTION_TYPES.LongRangeGun)
    .setFromRegion(REGION_INDICIES.BLACK_COMET_CHECKPOINT_TWO),
LevelRegion(STAGE_BLACK_COMET, REGION_INDICIES.BLACK_COMET_TWO_LIGHT_DASH,
                    REGION_RESTRICTION_TYPES.LightDash)
    .setFromRegion(REGION_INDICIES.BLACK_COMET_CHECKPOINT_TWO),
LevelRegion(STAGE_BLACK_COMET, REGION_INDICIES.BLACK_COMET_TWO_UP,
                    REGION_RESTRICTION_TYPES.LightDash)
    .setFromRegion([REGION_INDICIES.BLACK_COMET_TWO_LIGHT_DASH,
                   REGION_INDICIES.BLACK_COMET_TWO_AIR_SAUCER]),
...
LevelRegion(STAGE_BLACK_COMET, REGION_INDICIES.BLACK_COMET_SEVEN_AIR_SAUCER,
                    REGION_RESTRICTION_TYPES.AirSaucer),
LevelRegion(STAGE_BLACK_COMET, REGION_INDICIES.BLACK_COMET_SEVEN_WORMS,
                    REGION_RESTRICTION_TYPES.VacuumOrShot),
...
LevelRegion(STAGE_THE_LAST_WAY, REGION_INDICIES.THE_LAST_WAY_ABOVE_CHECKPOINT_4,
                    REGION_RESTRICTION_TYPES.NoRestriction),
...
LevelRegion(STAGE_THE_LAST_WAY, REGION_INDICIES.THE_LAST_WAY_VOLT_OR_WARP,
    ...
    .setFromRegion([REGION_INDICIES.THE_LAST_WAY_WARP_HOLE,
                    REGION_INDICIES.THE_LAST_WAY_ABOVE_CHECKPOINT_4]),
