...
BACKTRACKING_REGIONS = [
    ...
    BacktrackRegion(STAGE_WESTOPOLIS, REGION_INDICIES.DIGITAL_CIRCUIT_CHECKPOINT_ONE,
                    REGION_INDICIES.DIGITAL_CIRCUIT_BEHIND_ONE, Options.LogicLevel.option_easy,
                    REGION_RESTRICTION_TYPES.NoBacktracking),
    BacktrackRegion(STAGE_WESTOPOLIS, REGION_INDICIES.DIGITAL_CIRCUIT_CHECKPOINT_THREE,
                    REGION_INDICIES.DIGITAL_CIRCUIT_BEHIND_THREE, Options.LogicLevel.option_easy,
                    REGION_RESTRICTION_TYPES.NoBacktracking),
    BacktrackRegion(STAGE_WESTOPOLIS, REGION_INDICIES.DIGITAL_CIRCUIT_CHECKPOINT_FOUR,
