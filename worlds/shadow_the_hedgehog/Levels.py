...
FINAL_BOSSES = [BOSS_BLACK_DOOM_GF, BOSS_BLACK_DOOM_FH, BOSS_BLACK_DOOM_CF,
                BOSS_EGG_DEALER_BC, BOSS_EGG_DEALER_LS, BOSS_EGG_DEALER_CF,
                BOSS_DIABLON_GF, BOSS_DIABLON_BC, BOSS_DIABLON_FH]
...
CharacterToLevel = {
    ...
    "Vector": [STAGE_COSMIC_FALL, BOSS_BLACK_DOOM_CF],
