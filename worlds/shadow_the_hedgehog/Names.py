...
class REGION_INDICIES:
    ...
    DIGITAL_CIRCUIT_DARK_WARP_HOLE = 3
    ...
    CENTRAL_CITY_ROCKET_EASY = 1
    CENTRAL_CITY_BOMB_OR_BAZOOKA = 2
    CENTRAL_CITY_TRAVERSE_EASY = 3
    CENTRAL_CITY_KEY_DOOR = 4
    CENTRAL_CITY_BOMB_OR_BAZOOKA_2 = 5
    CENTRAL_CITY_GUN_TURRET = 6
    CENTRAL_CITY_ROCKET = 7
    CENTRAL_CITY_BOMB_OR_BAZOOKA_3 = 8
    ...
    DEATH_RUINS_KEY_DOOR = 2
    DEATH_RUINS_KEY_WARP = 3
    DEATH_RUINS_WALLS = 4
    ...
    # Enemysanity counting when you are stuck?
