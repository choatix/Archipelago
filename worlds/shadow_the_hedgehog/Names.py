...
class REGION_INDICIES:
    ...
    WESTOPOLIS_PULLEY = 3
    WESTOPOLIS_CHECKPOINT_THREE = 4
    WESTOPOLIS_WEAPON = 5
    WESTOPOLIS_CHECKPOINT_FOUR = 6
    WESTOPOLIS_KEY_DOOR = 7
    WESTOPOLIS_CHECKPOINT_FIVE = 8
    WESTOPOLIS_GOLD_BEETLE = 9
    WESTOPOLIS_CHECKPOINT_SIX = 10
    ...
    CRYPTIC_CASTLE_HAWK = 7
    CRYPTIC_CASTLE_HAWK_RIDE = 8
    CRYPTIC_CASTLE_HAWK_END_ITEM = 9
    CRYPTIC_CASTLE_ENEMY_HAWKS = 10
    CRYPTIC_CASTLE_CHECKPOINT_FOUR = 11
    CRYPTIC_CASTLE_TOP_PATH = 12
    CRYPTIC_CASTLE_UPPER_HAWK_RIDE = 13
    CRYPTIC_CASTLE_UPPER_HAWK_END_ITEM = 14
    CRYPTIC_CASTLE_CHECKPOINT_THREE = 15
    CRYPTIC_CASTLE_THREE_OR_FOUR = 16
    CRYPTIC_CASTLE_CHECKPOINT_FIVE = 17
    CRYPTIC_CASTLE_FIVE_BALLOON = 18
    CRYPTIC_CASTLE_KEY_DOOR = 19
    CRYPTIC_CASTLE_BOMB_EASY_2 = 20
    CRYPTIC_CASTLE_FIVE_TORCH = 21
    CRYPTIC_CASTLE_WIND_BOTTOM = 22
    CRYPTIC_CASTLE_CHECKPOINT_SIX = 23
    CRYPTIC_CASTLE_SIX_DARK = 24
    CRYPTIC_CASTLE_SIX_BALLOON = 25
    CRYPTIC_CASTLE_DARK_LIGHT_DASH = 26
    CRYPTIC_CASTLE_HAWK_2 = 27
    CRYPTIC_CASTLE_HAWK_RIDE_2 = 28
    CRYPTIC_CASTLE_END_HAWK_2_ITEM = 29
    CRYPTIC_CASTLE_ENEMY_HAWKS_2 = 30
    CRYPTIC_CASTLE_CHECKPOINT_SEVEN = 31
    CRYPTIC_CASTLE_CHECKPOINT_EIGHT = 32
    ...
    PRISON_ISLAND_CHECKPOINT_FOUR = 6
    PRISON_ISLAND_GOLD_BEETLE = 7
    PRISON_ISLAND_PULLEY_EASY = 8
    PRISON_ISLAND_FOUR_AIR_SAUCER = 9
    ...
    CENTRAL_CITY_CHECKPOINT_SIX = 17
    CENTRAL_CITY_BOMB_OR_BAZOOKA_3 = 18
    ...
    MAD_MATRIX_CHECKPOINT_SIX = 10
    MAD_MATRIX_YELLOW_ENTRY = 11
    MAD_MATRIX_YELLOW_START = 12
    MAD_MATRIX_CHECKPOINT_THREE = 13
    MAD_MATRIX_YELLOW_LIGHT_DASH = 14
    # No escape issue?

    MAD_MATRIX_GREEN_ENTRY = 15
    MAD_MATRIX_GREEN_START = 16
    MAD_MATRIX_CHECKPOINT_FIVE = 17
    MAD_MATRIX_GREEN_PROGRESSION = 18
    ...
    AIR_FLEET_CHECKPOINT_FOUR = 15
    AIR_FLEET_CHECKPOINT_FIVE = 16
    AIR_FLEET_FIVE_FLOATERS = 17
    AIR_FLEET_CHECKPOINT_SIX = 18
    AIR_FLEET_SECRET_3 = 19
    AIR_FLEET_CHECKPOINT_SEVEN = 20
    AIR_FLEET_SEVEN_DESCEND = 21
    AIR_FLEET_CHECKPOINT_EIGHT = 22
    ...
    IRON_JUNGLE_HERO_PULLEY = 22
    IRON_JUNGLE_HERO_ROCKET = 23
    IRON_JUNGLE_LIGHT_DASH_DARK = 24
    IRON_JUNGLE_CHECKPOINT_SEVEN = 25
    IRON_JUNGLE_DARK_PULLEY = 26
    IRON_JUNGLE_CHECKPOINT_EIGHT = 27
    ...
    BLACK_COMET_BLACK_TURRET = 19
    BLACK_COMET_KEY_DOOR = 20
    BLACK_COMET_BEHIND_KEY_DOOR = 21
    ...
    BLACK_COMET_SEVEN_ENEMY_FAR = 47
    ...
    COSMIC_FALL_ZIPWIRE_ENTRY = 5
    COSMIC_FALL_CHECKPOINT_TWO = 6
    COSMIC_FALL_PULLEY_CORE = 7
    COSMIC_FALL_ZIPWIRE_TO_3 = 8
    COSMIC_FALL_CHECKPOINT_THREE = 9
    COSMIC_FALL_BALLOON_RISE = 10
    COSMIC_FALL_CHECKPOINT_FOUR = 11
    COSMIC_FALL_ZIPWIRE_TO_5 = 12
    COSMIC_FALL_CHECKPOINT_FIVE = 13
    COSMIC_FALL_KEY_DOOR = 14
    COSMIC_FALL_LIGHT_DASH_UNLOCK = 15
    COSMIC_FALL_ZIPWIRE_TO_6 = 16
    COSMIC_FALL_CHECKPOINT_SIX = 17
    COSMIC_FALL_LIGHT_DASH = 18
    COSMIC_FALL_GUN_JUMPER = 19
    COSMIC_FALL_GUN_JUMPER_PULLEY_HARD = 20
    COSMIC_FALL_LD_OR_JUMPER = 21
    COSMIC_FALL_COMPUTER_ROOM_1 = 22
    COSMIC_FALL_COMPUTER_ROOM_2 = 23
    COSMIC_FALL_CHECKPOINT_SEVEN = 24
