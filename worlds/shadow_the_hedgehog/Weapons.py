...
[WeaponAttributes.NOT_AIMABLE]),
    WeaponInfo(0x16, "Wide Worm Shooter", 8, 5,
               [(Levels.STAGE_MAD_MATRIX, REGION_INDICIES.MAD_MATRIX_YELLOW_ENTRY),
                (Levels.STAGE_BLACK_COMET,REGION_INDICIES.BLACK_COMET_TWO_WORMS),
                Levels.STAGE_THE_LAST_WAY],
[WeaponAttributes.NOT_AIMABLE]),
    WeaponInfo(0x17, "Big Worm Shooter", 16, 5,
               [(Levels.STAGE_BLACK_COMET,REGION_INDICIES.BLACK_COMET_THREE_FLOATERS),
...
[WeaponAttributes.SHOT]),
    WeaponInfo(0x1B, "Refractor", 5, 20,
               [(Levels.STAGE_BLACK_COMET,REGION_INDICIES.BLACK_COMET_AIR_SAUCER),
                #(Levels.STAGE_BLACK_COMET,REGION_INDICIES.BLACK_COMET_END_WORMS),
                #(Levels.STAGE_BLACK_COMET,REGION_INDICIES.BLACK_COMET_LATER_WORMS),
                #(Levels.STAGE_BLACK_COMET,REGION_INDICIES.BLACK_COMET_SIX_WORMS),
                #(Levels.STAGE_BLACK_COMET,REGION_INDICIES.BLACK_COMET_SEVEN_WORMS),
