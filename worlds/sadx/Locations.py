...
location_table: List[LocationInfo] = [
    ...
    {"id": 3, "name": "Unlock Knuckles' Story", "needItem": -1},
    {"id": 4, "name": "Unlock Amy's Story", "needItem": -1},
    {"id": 5, "name": "Unlock Gamma's Story", "needItem": -1},
    {"id": 6, "name": "Unlock Big's Story", "needItem": -1},
