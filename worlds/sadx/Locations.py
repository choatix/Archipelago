...
from .Enums import Area, SubLevel, Character, LevelMission, EVERYONE, SubLevelMission, pascal_to_space, \
    SADX_BASE_ID, SONIC_TAILS
...
field_emblem_location_table: List[EmblemLocation] = [
    ...
    EmblemLocation(23, Area.Jungle, [Character.Tails, Character.Knuckles], "Tree Stump Emblem"),
    EmblemLocation(30, Area.EggCarrierMain, [Character.Tails, Character.Knuckles], "Pool Emblem"),
...
life_capsule_location_table: List[LifeCapsuleLocation] = [
    ...
    LifeCapsuleLocation(1110, Area.WindyValley, Character.Sonic, 1,
                        [ItemName.KeyItem.WindStone, ItemName.Sonic.LightShoes]),
    LifeCapsuleLocation(1111, Area.WindyValley, Character.Sonic, 2, [ItemName.KeyItem.WindStone]),
    LifeCapsuleLocation(1112, Area.WindyValley, Character.Sonic, 3, [ItemName.KeyItem.WindStone]),
    LifeCapsuleLocation(1113, Area.WindyValley, Character.Sonic, 4,
                        [ItemName.KeyItem.WindStone, ItemName.Sonic.LightShoes]),
    LifeCapsuleLocation(1114, Area.WindyValley, Character.Sonic, 5, [ItemName.KeyItem.WindStone]),
    LifeCapsuleLocation(1210, Area.Casinopolis, Character.Sonic, 1, [ItemName.Sonic.LightShoes]),
    LifeCapsuleLocation(1211, Area.Casinopolis, Character.Sonic, 2, [ItemName.Sonic.LightShoes]),
    LifeCapsuleLocation(1212, Area.Casinopolis, Character.Sonic, 3, [ItemName.Sonic.LightShoes]),
    ...
    LifeCapsuleLocation(1510, Area.SpeedHighway, Character.Sonic, 1, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1511, Area.SpeedHighway, Character.Sonic, 2, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1512, Area.SpeedHighway, Character.Sonic, 3, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1513, Area.SpeedHighway, Character.Sonic, 4, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1514, Area.SpeedHighway, Character.Sonic, 5, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1515, Area.SpeedHighway, Character.Sonic, 6, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1516, Area.SpeedHighway, Character.Sonic, 7, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1517, Area.SpeedHighway, Character.Sonic, 8, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(1518, Area.SpeedHighway, Character.Sonic, 9, [ItemName.KeyItem.EmployeeCard]),
    ...
    LifeCapsuleLocation(1613, Area.RedMountain, Character.Sonic, 4,
                        [ItemName.Sonic.LightShoes, ItemName.Sonic.AncientLight]),
    LifeCapsuleLocation(1614, Area.RedMountain, Character.Sonic, 5,
                        [ItemName.Sonic.LightShoes, ItemName.Sonic.AncientLight]),
    LifeCapsuleLocation(1615, Area.RedMountain, Character.Sonic, 6,
                        [ItemName.Sonic.LightShoes, ItemName.Sonic.AncientLight]),
    ...
    LifeCapsuleLocation(2010, Area.WindyValley, Character.Tails, 1, [ItemName.KeyItem.WindStone]),
    ...
    LifeCapsuleLocation(2410, Area.SpeedHighway, Character.Tails, 1, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(2411, Area.SpeedHighway, Character.Tails, 2, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(2412, Area.SpeedHighway, Character.Tails, 3, [ItemName.KeyItem.EmployeeCard]),
    LifeCapsuleLocation(2413, Area.SpeedHighway, Character.Tails, 4, [ItemName.KeyItem.EmployeeCard]),
    ...
    LifeCapsuleLocation(3210, Area.RedMountain, Character.Knuckles, 1, [ItemName.Knuckles.ShovelClaw]),
    LifeCapsuleLocation(3211, Area.RedMountain, Character.Knuckles, 2, [ItemName.Knuckles.ShovelClaw]),
    LifeCapsuleLocation(3212, Area.RedMountain, Character.Knuckles, 3, [ItemName.Knuckles.ShovelClaw]),
    LifeCapsuleLocation(3213, Area.RedMountain, Character.Knuckles, 4, [ItemName.Knuckles.ShovelClaw]),
    ...
    LifeCapsuleLocation(5210, Area.WindyValley, Character.Gamma, 1,
                        [ItemName.KeyItem.WindStone, ItemName.Gamma.JetBooster]),
    LifeCapsuleLocation(5211, Area.WindyValley, Character.Gamma, 2,
                        [ItemName.KeyItem.WindStone, ItemName.Gamma.JetBooster]),
...
mission_location_table: List[MissionLocation] = [
    ...
    MissionLocation(818, Area.Station, Area.TwinkleParkLobby, Character.Amy, 18, []),
    ...
    MissionLocation(823, Area.TwinkleParkLobby, Area.TwinkleParkLobby, Character.Sonic, 23, []),
    ...
    MissionLocation(849, Area.StationSquareMain, Area.TwinkleParkLobby, Character.Sonic, 49, []),
    ...
    MissionLocation(853, Area.AngelIsland, Area.AngelIsland, Character.Sonic, 53,
                    [ItemName.KeyItem.IceStone, ItemName.KeyItem.CasinoKeys, ItemName.KeyItem.Train]),
    MissionLocation(854, Area.AngelIsland, Area.AngelIsland, Character.Tails, 54,
                    [ItemName.KeyItem.IceStone, ItemName.KeyItem.CasinoKeys, ItemName.KeyItem.Train]),
    MissionLocation(855, Area.TwinkleParkLobby, Area.StationSquareMain, Character.Sonic, 55,
                    [ItemName.KeyItem.EmployeeCard]),
    ...
    MissionLocation(857, Area.AngelIsland, Area.MysticRuinsMain, Character.Sonic, 57,
                    [ItemName.Sonic.LightShoes, ItemName.Sonic.AncientLight]),
    MissionLocation(858, Area.Jungle, Area.Jungle, Character.Sonic, 58, []),
...
def get_location_from_level() -> List[LocationInfo]:
    ...
    for level in level_location_table:
        level_name: str = f"{pascal_to_space(level.area.name)} ({level.character.name} - Mission {level.levelMission.name})"
