...
field_emblem_location_table: List[EmblemLocation] = [
    ...
    EmblemLocation(21, Area.AngelIsland, [Character.Knuckles], [Character.Sonic, Character.Tails, Character.Knuckles],
                   [Character.Sonic, Character.Tails, Character.Knuckles], "Shrine Emblem"),
    ...
    EmblemLocation(23, Area.Jungle, [Character.Tails, Character.Knuckles], [Character.Tails, Character.Knuckles],
                   [Character.Tails, Character.Knuckles], "Tree Stump Emblem"),
    EmblemLocation(30, Area.EggCarrierMain, [Character.Tails, Character.Knuckles],
                   [Character.Tails, Character.Knuckles], [Character.Tails, Character.Knuckles], "Pool Emblem"),
    ...
    EmblemLocation(32, Area.EggCarrierMain, [Character.Tails, Character.Sonic], [Character.Tails, Character.Sonic],
                   [Character.Tails, Character.Sonic], "Hidden Bed Emblem"),
    EmblemLocation(33, Area.EggCarrierMain, [Character.Sonic], [Character.Sonic], [Character.Sonic],
